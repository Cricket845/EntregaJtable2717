...
public class daoUsuario {
    ...
    public JSONObject select(int jtStartIndex, int jtPageSize, String jtSorting) {
        ...
        try {
            ...
            //varSql = "SELECT * FROM [dbo].[usuario]" + " ORDER BY " + jtSorting + " OFFSET " + jtStartIndex + " ROWS FETCH NEXT " + jtPageSize + " ROWS ONLY ";
             //varSql = "SELECT * FROM usuario ORDER BY \"Nombre\"ASC"+ " LIMIT " + jtPageSize + "OFFSET " + jtStartIndex + "; ";
            System.out.println(varSql);
            // sql = "SELECT COUNT(*) as TotalRecordCount FROM [dbo].[usuario]" ;
